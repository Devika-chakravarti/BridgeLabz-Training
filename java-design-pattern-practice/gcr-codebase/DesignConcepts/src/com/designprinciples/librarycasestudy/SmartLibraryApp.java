...
public class SmartLibraryApp {
	...
	public static void main(String[] args) {
		...
		Book dsBook = new Book.BookBuilder("978-0262033848", "Introduction to Algorithms")
				...
				.withEdition(3).withPublisher("MIT Press").withGenre("Computer Science").build();

		Book javaBook = new Book.BookBuilder("978-0134685991", "Effective Java").withAuthors("Joshua Bloch")
				.withEdition(3).withPublisher("Addison-Wesley").withGenre("Programming").build();
