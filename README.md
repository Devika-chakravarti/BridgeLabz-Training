...
### 🗓 Day 11 – Leetcode questions  (Branch: core-java-practice)
**(Date: 28-Dec-2025)**
...
### 🗓 Day 12 – Important Java keywords (Branch: java-oops-practice)
**(Date: 29-Dec-2025)**
...
### 🗓 Day 13 – Object Oriented Design principles (Branch: java-oops-practice)
**(Date: 30-Dec-2025)**
...
### 🗓 Day 13 – Scenario-based questions (Branch: core-java-practice)
**(Date: 30-Dec-2025)** 
- Scenario-based problems:
  - Temperature Logger
...
### 🗓 Day 14 – Scenario-based questions (Branch: core-java-practice)
**(Date: 31-Dec-2025)** 
- Scenario-based problems:
...
### 🗓 Day 14 – Inheritance (Branch: java-oops-practice)
**(Date: 31-Dec-2025)**
...
🔗 *Code Link:*  
👉 [Day 16 – Scenario-based questions](https://github.com/Devika-chakravarti/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based/ScenarioBasedProblems/src/com)
...
🔗 *Code Link:*  
👉 [Day 18 – Scenario-based questions](https://github.com/Devika-chakravarti/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based/ScenarioBasedProblems/src/com)
...
🔗 *Code Link:*  
👉 [Day 26 – Scenario-based problems](https://github.com/Devika-chakravarti/BridgeLabz-Training/tree/dsa-practice/dsa-practice/scenario-based-codebase/ScenarioBasedProblems/src/com/sorting)
...
### 🗓 Day 41 – Design Principles & Design Patterns  (Branch: java-design-pattern-practice)
**(Date: 31-Jan-2026)**
...
- Few additional design principles:
  - DRY, KISS, YAGNI, SoC
...
- Solved pattern-based exercies and mini design problem
- Committed and pushed all work

🔗 *Code Link:*  
👉 [Day 41 – Design Principles & Patterns](https://github.com/Devika-chakravarti/BridgeLabz-Training/tree/java-design-pattern-practice/java-design-pattern-practice/gcr-codebase/DesignConcepts/src/com/designprinciples/librarycasestudy)

---

### 🗓 Day 43 – Multithreading in Java  (Branch: java-design-pattern-practice)
**(Date: 02-Feb-2026)**

- Studied process vs thread concepts.
...
🔗 *Code Link:*  
👉 [Day 43 – Multithreading](https://github.com/Devika-chakravarti/BridgeLabz-Training/tree/java-design-pattern-practice/java-design-pattern-practice/gcr-codebase/DesignConcepts/src/com/multithreading)

---

### 🗓 Day 47 – DBMS fundamentals, Indexing & SQL best practices
**(Date: 06-Feb-2026)**
...
🔗 *Code Link:*  
👉 [Day 47 – DBMS & SQL practice](https://github.com/Devika-chakravarti/BridgeLabz-Training/tree/dbms-jdbc-practice/dbms-jdbc-practice/gcr-codebase/MySQLdatabase/src/main/java/com/mysqlpractice)
